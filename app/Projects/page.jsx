...
function ProjectPage() {
  return (
    <div
      className={`${roboto.className} w-full bg-contriverBgRotatePhone bg-cover sm:bg-contriverBgRotate bg-cover bg-no-repeat bg-top`}
    >
      <h1 className="text-3xl sm:text-7xl font-bold text-gray-700 text-center pt-10 sm:py-10 py-5 px-8 lg:px-40 uppercase animate-fade animate-once animate-duration-1000 animate-delay-0 animate-ease-linear animate-normal animate-fill-forwards">
        What Have We Done?
      </h1>
      <h2 className="text-gray-700 font-bold text-xl sm:text-3xl text-center sm:pb-10 pb-5 px-8 lg:px-40 animate-fade animate-once animate-duration-1000 animate-delay-0 animate-ease-linear animate-normal animate-fill-forwards">
      ...
      <div className="hidden sm:flex flex-col sm:w-3/4 mx-auto px-20 space-y-10 pb-10 ">
        {about.map((item, ind) => (
          <div key={ind} className="relative py-5 bg-blue-50">
            <div className="flex flex-row space-x-5 z-10 py-4 px-10">
              ...
              {/* Features */}
              <div className="sm:w-4/12 py-5 pl-8 mr-2 bg-gray-700 animate-fade-left animate-once animate-duration-1500  animate-ease-in-out animate-normal animate-fill-forwards">
